...
;
;     nasm -felf64 inverted_triangle.asm && ld -o inverted_triangle inverted_triangle.asm && ./inverted_triangle
; ----------------------------------------------------------------------------------------
...
lineDone:
          ...
          cmp       r8, 0                   ; wait, did we already finish the last line?
          jg        line                    ; if not, begin writing this line
done:
